...
class LLM(BeamSearchOfflineMixin, PoolingOfflineMixin, OfflineInferenceMixin):
    ...
    Args:
        ...
        enable_moe_activation_trace: Whether to stream generation-only MoE
            activation windows.
    ...
    def __init__(
        ...
        *,
        ...
        enable_moe_activation_trace: bool = False,
        ...
        **kwargs: Any,
        ...
        engine_args = EngineArgs(
            ...
            enable_moe_activation_trace=enable_moe_activation_trace,
