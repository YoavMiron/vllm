...
class EngineArgs:
    ...
    enable_moe_activation_trace: bool = ModelConfig.enable_moe_activation_trace
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        model_group.add_argument(
            "--enable-moe-activation-trace",
            **model_kwargs["enable_moe_activation_trace"],
        )
    ...
    def create_model_config(self) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            enable_moe_activation_trace=self.enable_moe_activation_trace,
